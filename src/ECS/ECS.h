...
class Registry {
	private:
		...
		// Vector of component pools, each pool contains all the date for certain component type
		...
		// Set of entities that are flagged to be added or removed in the enxt registry Update()
		...
		// List of free entity ids that were previouly removed
